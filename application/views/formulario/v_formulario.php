...
<div id="page-wrapper" xmlns="http://www.w3.org/1999/html">
                ...
                <div class="panel-body">
                    <form role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control">
                            <p class="help-block">El plazo estimado debe de estar en <strong>dias calendario</strong></p>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <button type="button" class="btn btn-primary btn-lg btn-block">REGISTRAR INFORME TÉCNICO DE CONDICIONES PREVIAS (ITCP)</button>
                </div>
            </div>
        </div>
    </div>
